...
export function TarjetaSeccion({ seccion, indice, total, alActualizar, alEliminar, alMover }: TarjetaSeccionProps) {
  return (
    <Card className="p-6">
      <div className="flex items-start justify-between mb-4">
        <h3 className="text-lg font-semibold">Sección {indice + 1}</h3>
        <div className="flex gap-2">
          <Button variant="outline" size="sm" onClick={() => alMover(indice, "up")} disabled={indice === 0}>
            <ArrowUp className="h-4 w-4" />
          </Button>
          <Button variant="outline" size="sm" onClick={() => alMover(indice, "down")} disabled={indice === total - 1}>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(valor) => alActualizar(indice, "imagePosition", valor)}
          >
        ...
        <div className="space-y-2 md:col-span-2">
          ...
          <Textarea
            ...
            onChange={(e) => alActualizar(indice, "description", e.target.value.split("\n"))}
            rows={6}
          />
        </div>
    ...
    <Label>Imagen de la Sección</Label>
      ...
      {seccion.image && (
        <div className="mt-4">
          ...
          <img
            src={seccion.image || "/placeholder.svg"}
